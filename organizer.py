...
def organize(directory):
    ...
    for file in files:
        ...
        match ext:
            case '.abw'|'.aww'|'.chm'|'.cnt'|'.dbx'|'.doc'|'.docm'|'.docx'|'.dot'|'.dotm'|'.dotx'|'.epub'|'.ind'|'.indd'|'.key'|'.keynote'|'.mht'|'.mpp'|'.odf'|'.ods'|'.odt'|'.opx'|'.ott'|'.oxps'|'.pages'|'.pdf'|'.pmd'|'.pot'|'.potx'|'.pps'|'.ppsx'|'.ppt'|'.pptm'|'.pptx'|'.prn'|'.ps'|'.pub'|'.pwi'|'.sdd'|'.sdw'|'.shs'|'.snp'|'.sxw'|'.tpl'|'.vsd'|'.wpd'|'.wps'|'.wri'|'.xps'|'.numbers'|'.sdc'|'.sxc'|'.xls'|'.xlsm'|'.xlsx':
                move_files(directory, file, '/Documents/')
            case '.3ga'|'.aac'|'.aiff'|'.amr'|'.ape'|'.arf'|'.cda'|'.dvf'|'.flac'|'.gp4'|'.gp5'|'.gpx'|'.logic'|'.m4a'|'.m4b'|'.m4p'|'.midi'|'.mp3'|'.ogg'|'.opus'|'.pcm'|'.snd'|'.sng'|'.uax'|'.wav'|'.wma'|'.wpl':
            ...
            case '.bmp'|'.cpt'|'.dds'|'.dib'|'.dng'|'.emf'|'.gif'|'.heic'|'.ico'|'.icon'|'.jpeg'|'.jpg'|'.pcx'|'.pic'|'.png'|'.psdx'|'.raw'|'.tga'|'.tif'|'.tiff'|'.wbmp'|'.wdp'|'.webp':
                move_files(directory, file, '/Images/')
            case '.air'|'.app'|'.application'|'.appx'|'.bat'|'.bin'|'.com'|'.cpl'|'.dll'|'.elf'|'.exe'|'.jar'|'.js':
                move_files(directory, file, '/Executable Files/')
            case '.abr'|'.ai'|'.ani'|'.cdt'|'.djvu'|'.eps'|'.fla'|'.icns'|'.mdi'|'.odg'|'.psb'|'.psd'|'.pzl'|'.sup'|'.vsdx':
            ...
            case '.1st'|'.alx'|'.asp'|'.csv'|'.htm'|'.html'|'.log'|'.lrc'|'.lst'|'.md'|'.nfo'|'.opml'|'.plist'|'.reg'|'.rtf'|'.srt'|'.sub'|'.tbl'|'.text'|'.txt'|'.xml'|'.xmp'|'.xsd'|'.xsl'|'.xslt'|'.ini':
                move_files(directory, file, '/Text Files/')
            case '.001'|'.002'|'.003'|'.004'|'.005'|'.006'|'.007'|'.008'|'.009'|'.010'|'.7z'|'.7z.001'|'.7z.002'|'.7z.003'|'.7z.004'|'.7zip'|'.a00'|'.a01'|'.a02'|'.a03'|'.a04'|'.a05'|'.ace'|'.appxbundle'|'.arc'|'.arj'|'.bar'|'.c00'|'.c01'|'.c02'|'.c03'|'.cab'|'.cbr'|'.cbz'|'.cso'|'.deb'|'.dlc'|'.gz'|'.gzip'|'.hqx'|'.inv'|'.isz'|'.msu'|'.pak'|'.part1.exe'|'.part1.rar'|'.part2.rar'|'.pkg'|'.r00'|'.r01'|'.r02'|'.r03'|'.r04'|'.r05'|'.r06'|'.r07'|'.r08'|'.r09'|'.r10'|'.rar'|'.rpm'|'.sit'|'.sitd'|'.sitx'|'.tar'|'.tar.gz'|'.tgz'|'.vsix'|'.webarchive'|'.z01'|'.z02'|'.z03'|'.z04'|'.z05'|'.zab'|'.zip'|'.zipx':
                move_files(directory, file, '/Compressed Files/')
            case '.000'|'.ccd'|'.cue'|'.daa'|'.dao'|'.dmg'|'.img'|'.iso'|'.mds'|'.mdx'|'.nrg'|'.tao'|'.tc'|'.toast'|'.uif'|'.vcd':
            ...
            case '.accdb'|'.accdt'|'.db'|'.dbf'|'.fdb'|'.gdb'|'.idx'|'.mdb'|'.mdf'|'.sdf'|'.sql'|'.sqlite'|'.wdb':
